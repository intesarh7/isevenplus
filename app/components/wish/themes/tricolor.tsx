export default function TricolorTheme({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-linear-to-br from-orange-500 via-white to-green-600 text-gray-900 flex items-center justify-center text-center p-6 w-full">
